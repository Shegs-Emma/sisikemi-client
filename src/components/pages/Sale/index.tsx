      ...
      <div className="flex flex-col w-full border-b-[0.5px] border-b-[#4f4f4f] pb-[7rem]">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-14 px-[1.5rem] py-0">
          <div className="flex flex-col">
            <div className="absolute z-10 mt-[0.7rem] sm:ml-[13rem] ml-[6rem] w-[59px] h-[23px] text-center bg-[#4f4f4f] rounded-[1px]">
              <span className="font-montserrat font-medium text-xs text-[#FAFAFA] w-full sm:w-[31%] text-center pb-[0.5rem] mx-auto sm:mt-[1rem]">
                SALE
              </span>
            </div>
            <Image
            ...
            <div className="flex flex-col text-center">
              ...
              <div className="flex justify-center">
                <p className="font-montserrat font-semibold text-xs text-[#812a25] m-0 mr-2">
                  N24,000
                </p>
                <p className="font-montserrat font-semibold text-xs text-[#4f4f4f] line-through m-0">
                  N24,000
                </p>
              </div>
            </div>
