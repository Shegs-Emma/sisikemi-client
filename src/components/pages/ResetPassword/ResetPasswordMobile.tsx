...
const ResetPasswordMobile: FC<VerificationCodeProps> = ({
  onSubmit,
  ...
  return (
    <div className="flex sm:hidden flex-col w-full bg-[#ffffff] py-6 px-4 m-[auto] mt-12">
      ...
      <div className="flex flex-col w-full mt-8">
        <div className="flex flex-col w-full mt-8">
          ...
          <button
            type="button"
            onClick={viewerNew}
            className="transform -translate-y-1/2 mt-5 mx-2 absolute left-[20rem]"
          >
            {visibilityNew ? (
